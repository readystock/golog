...
func (l *Logger) Print(v ...interface{}) {
	l.print(l.StackDepth-1, DisableLevel, fmt.Sprint(v...), l.NewLine)
}

// Printf formats according to a format specifier and writes to `Printer#Output` without levels and colors.
func (l *Logger) Printf(format string, args ...interface{}) {
	l.print(l.StackDepth-1, DisableLevel, fmt.Sprintf(format, args...), l.NewLine)
}
...
func (l *Logger) Println(v ...interface{}) {
	l.print(l.StackDepth-1, DisableLevel, fmt.Sprint(v...), true)
}
...
func (l *Logger) Log(stack int, level Level, v ...interface{}) {
	l.print(l.StackDepth, level, fmt.Sprint(v...), l.NewLine)
}
...
func (l *Logger) Fatal(v ...interface{}) {
	l.Log(l.StackDepth, FatalLevel, v...)
}
...
func (l *Logger) Verbose(v ...interface{}) {
	l.Log(l.StackDepth, VerboseLevel, v...)
}
