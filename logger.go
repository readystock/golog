...
// failed.
func CallerInfo(stack int) string {
    // debug.PrintStack()
    file := ""
    line := 0
    ok := false
...
func (l *Logger) print(stack int, level Level, msg string, newLine bool) {
    if l.Level >= level {
        ...
        // or by simply, Print.
        log := l.acquireLog(stack, level, msg, newLine)
...
func (l *Logger) Print(stack int, v ...interface{}) {
    l.print(stack, DisableLevel, fmt.Sprint(v...), l.NewLine)
}

// Printf formats according to a format specifier and writes to `Printer#Output` without levels and colors.
func (l *Logger) Printf(stack int, format string, args ...interface{}) {
    l.print(stack, DisableLevel, fmt.Sprintf(format, args...), l.NewLine)
}

// Println prints a log message without levels and colors.
// It adds a new line at the end, it overrides the `NewLine` option.
func (l *Logger) Println(stack int, v ...interface{}) {
    l.print(stack, DisableLevel, fmt.Sprint(v...), true)
}
...
func (l *Logger) Log(stack int, level Level, v ...interface{}) {
    l.print(stack, level, fmt.Sprint(v...), l.NewLine)
}

// Logf prints a leveled log message to the output.
// This method can be used to use custom log levels if needed.
// It adds a new line in the end.
func (l *Logger) Logf(stack int, level Level, format string, args ...interface{}) {
    msg := fmt.Sprintf(format, args...)
    l.Log(stack, level, msg)
}

// Fatal `os.Exit(1)` exit no matter the level of the logger.
// If the logger's level is fatal, error, warn, info or debug
// then it will print the log message too.
func (l *Logger) Fatal(stack int, v ...interface{}) {
    l.Log(stack, FatalLevel, v...)
}

// Fatalf will `os.Exit(1)` no matter the level of the logger.
// If the logger's level is fatal, error, warn, info or debug
// then it will print the log message too.
func (l *Logger) Fatalf(stack int, format string, args ...interface{}) {
    msg := fmt.Sprintf(format, args...)
    l.Fatal(stack, msg)
}

// Error will print only when logger's Level is error, warn, info or debug.
func (l *Logger) Error(stack int, v ...interface{}) {
    l.Log(stack, ErrorLevel, v...)
}

// Errorf will print only when logger's Level is error, warn, info or debug.
func (l *Logger) Errorf(stack int, format string, args ...interface{}) {
    msg := fmt.Sprintf(format, args...)
    l.Error(stack, msg)
}

// Warn will print when logger's Level is warn, info or debug.
func (l *Logger) Warn(stack int, v ...interface{}) {
    l.Log(stack, WarnLevel, v...)
}

// Warnf will print when logger's Level is warn, info or debug.
func (l *Logger) Warnf(stack int, format string, args ...interface{}) {
    msg := fmt.Sprintf(format, args...)
    l.Warn(stack, msg)
}

// Info will print when logger's Level is info or debug.
func (l *Logger) Info(stack int, v ...interface{}) {
    l.Log(stack, InfoLevel, v...)
}

// Infof will print when logger's Level is info or debug.
func (l *Logger) Infof(stack int, format string, args ...interface{}) {
    msg := fmt.Sprintf(format, args...)
    l.Info(stack, msg)
}

// Debug will print when logger's Level is debug.
func (l *Logger) Debug(stack int, v ...interface{}) {
    l.Log(stack, DebugLevel, v...)
}

// Debugf will print when logger's Level is debug.
func (l *Logger) Debugf(stack int, format string, args ...interface{}) {
...
// Debug will print when logger's Level is debug.
func (l *Logger) Verbose(stack int, v ...interface{}) {
    l.Log(stack, VerboseLevel, v...)
}

// Debugf will print when logger's Level is debug.
func (l *Logger) Verbosef(stack int, format string, args ...interface{}) {
    // On debug mode don't even try to fmt.Sprintf if it's not required,
    // this can be used to allow `Debugf` to be called without even the `fmt.Sprintf`'s
    // performance cost if the logger doesn't allow debug logging.
    if l.Level >= DebugLevel {
